...
#define PGCOPYDB_COPY_GROUPS "PGCOPYDB_COPY_GROUPS"
...
#define PGCOPYDB_SKIP_XID_CHECK "PGCOPYDB_SKIP_XID_CHECK"
...
#define DEFAULT_RESTORE_TOLERANCE 10
#define DEFAULT_COPY_GROUPS 1 /* single group: byte-for-byte today's behavior */
